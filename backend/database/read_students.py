...
def read_students_data(column1, value):
    select_query = "SELECT email, student_id, name, display_name, degree, course, bio, timetable_publicity FROM students WHERE " + column1 + "='" + value +"'"
    conn = None
    user_info = []
    try:
...
# print(read_students_data('email', 'hh@m.com'))